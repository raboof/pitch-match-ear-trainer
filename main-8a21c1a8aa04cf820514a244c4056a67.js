			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('This game helps you train \'pitch matching\' by ear. It is best enjoyed alone or with headphones.')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$Calibrate),
								A2($elm$html$Html$Attributes$attribute, 'class', 'button')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Calibrate volume')
							]))
					]));
		case 'Calibrating':
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('You should now hear a \'target pitch\'. Later you will be challenged to match this pitch. Take a minute to adjust your volume so it is comfortable')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$Try),
								A2($elm$html$Html$Attributes$attribute, 'class', 'button')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('I\'m happy')
							]))
					]));
		case 'Trying':
			var goingFor = _v0.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('You can \'play\' by touching the screen. Try it!')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'class', 'huge')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$ToggleMute),
								A2($elm$html$Html$Attributes$attribute, 'class', 'mute')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Nice! You got it!')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{debug: flags.debug, muted: false, page: $author$project$Main$Init, windowHeight: flags.windowHeight, y: 0},
...
var $author$project$Main$getTouchY = function (obj) {
	var _v0 = A2(
...
var $author$project$Main$onMouseEnter = _Platform_incomingPort(
	'onMouseEnter',
	A2(
...
var $author$project$Main$onMouseOut = _Platform_incomingPort(
	'onMouseOut',
	$elm$json$Json$Decode$succeed(
		{}));
var $author$project$Main$onTouchCancel = _Platform_incomingPort(
	'onTouchCancel',
	$elm$json$Json$Decode$succeed(
		{}));
var $author$project$Main$onTouchEnd = _Platform_incomingPort(
	'onTouchEnd',
	$elm$json$Json$Decode$succeed(
		{}));
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Main$onMouseOut(
				function (_v2) {
					return $author$project$Main$MouseUp;
				}),
				$author$project$Main$onTouchCancel(
				function (_v3) {
					return $author$project$Main$MouseUp;
				}),
				A2(
...
var $author$project$Main$maxPitch = 1000;
...
var $author$project$Main$setSounds = _Platform_outgoingPort('setSounds', $elm$core$Basics$identity);
...
var $author$project$Main$encodeSounds = F4(
	function (tGain, tFreq, pGain, pFreq) {
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'gain',
								$elm$json$Json$Encode$float(tGain)),
								_Utils_Tuple2(
								'frequency',
								$elm$json$Json$Encode$int(tFreq))
							]))),
					_Utils_Tuple2(
					'pointed',
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'gain',
								$elm$json$Json$Encode$float(pGain)),
								_Utils_Tuple2(
								'frequency',
								$elm$json$Json$Encode$int(pFreq))
							])))
				]));
	});
	...
	if (model.muted) {
		...
		switch (_v0.$) {
			case 'Init':
				return $author$project$Main$silent;
			case 'Calibrating':
				return A4($author$project$Main$encodeSounds, 0.4, 800, 0, 0);
			case 'Trying':
				if (_v0.b.$ === 'Down') {
					var pointedFreq = _v0.b.a;
					return A4($author$project$Main$encodeSounds, 0, 0, 0.4, pointedFreq);
				} else {
					var _v1 = _v0.b;
					return $author$project$Main$silent;
				}
...
var $author$project$Main$Found = {$: 'Found'};
var $elm$core$Basics$neq = _Utils_notEqual;
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Main$success = _Platform_outgoingPort(
	'success',
	function ($) {
...
var $author$project$Main$setY = F2(
	function (model, y) {
		...
		switch (_v0.$) {
			...
			case 'Calibrating':
				return $author$project$Main$Calibrating;
			case 'Trying':
				var goingFor = _v0.a;
				return A2(
					$author$project$Main$Trying,
					goingFor,
...
var $author$project$Main$up = function (model) {
	switch (model.$) {
		case 'Init':
			return $author$project$Main$Init;
		case 'Calibrating':
		...
		switch (msg.$) {
			case 'Calibrate':
				return _Utils_update(
					model,
					{page: $author$project$Main$Calibrating});
			case 'Try':
				return _Utils_update(
					model,
					{
			...
			case 'MouseMoved':
				...
				return _Utils_update(
					model,
					{
						page: A2($author$project$Main$setY, model, y),
						y: y
					});
			case 'MouseUp':
				return _Utils_update(
					model,
					{
						page: $author$project$Main$up(model.page)
					});
			case 'Error':
				var e = msg.a;
				return _Utils_update(
					model,
					{
						page: $author$project$Main$ErrorPage(e)
					});
			case 'Tick':
				return _Utils_update(
					model,
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var updated = A2($author$project$Main$updateModel, model, msg);
		return _Utils_Tuple2(
			updated,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$effect(msg),
						A2($author$project$Main$transition, model.page, updated.page),
						$author$project$Main$setSounds(
						$author$project$Main$sounds(updated))
					])));
	});
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$debugView});
	...
	A2(
		...
		function (windowHeight) {
			return A2(
				...
				function (debug) {
					return $elm$json$Json$Decode$succeed(
						{debug: debug, windowHeight: windowHeight});
				},
				A2($elm$json$Json$Decode$field, 'debug', $elm$json$Json$Decode$bool));
		},
		A2($elm$json$Json$Decode$field, 'windowHeight', $elm$json$Json$Decode$int)))(0)}});}(this));